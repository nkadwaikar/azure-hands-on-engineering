...
| Assessing workload protection & threat detection | [Defender for Servers](Defender%20for%20Servers/README.md) | Defender for Servers Plan 2, Secure Score and recommendations, vulnerability assessment (CVE scanning via MDE — no separate agent), File Integrity Monitoring (FIM), security alert investigation, and Just-In-Time (JIT) VM access — covers Azure VMs and Arc-enabled servers |
