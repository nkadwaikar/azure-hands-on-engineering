...
- [Identity Fundamentals](Identity-First/01-identity%20fundamentals.md) — Entra ID core concepts, tenant structure, authentication flows
...
- [Azure Locks & Resource Policies](Identity-First/04-azurelocks-resource-policies.md) — Prevent accidental deletion; enforce tagging and SKU constraints
...
*Last updated: June 2026 — Powered by coffee, a great team, and the belief that clean engineering is the kindest thing you can do for the people who come after you.*