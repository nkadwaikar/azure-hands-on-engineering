...
2. Collect log evidence (extension logs, Windows Update log) per the post-run validation workflow in [1-Azure Update Manager.md — Section 2](1-Azure%20Update%20Manager.md#2-validate-logs-after-the-run).
