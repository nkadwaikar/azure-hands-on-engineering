...
| [Defender for Servers](../Defender%20for%20Servers/README.md) | Defender for Office 365 threat protection (Lab 1) and Defender for Cloud Apps session controls (Lab 5) surface in the same Microsoft Defender portal used in the Defender for Servers track. Alerts from Azure VMs and M365 workloads are unified in Microsoft Defender XDR for end-to-end incident investigation. |
